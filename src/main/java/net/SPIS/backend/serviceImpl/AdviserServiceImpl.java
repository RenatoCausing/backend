...
public class AdviserServiceImpl implements AdviserService {
    ...
    public AdviserDTO updateAdviser(Integer adviserId, AdviserDTO adviserDTO) {
        ...
        // Update properties
        if (adviserDTO.getFirstName() != null) admin.setFirstName(adviserDTO.getFirstName());
        if (adviserDTO.getLastName() != null) admin.setLastName(adviserDTO.getLastName());
        if (adviserDTO.getMiddleName() != null) admin.setMiddleName(adviserDTO.getMiddleName());
        if (adviserDTO.getEmail() != null) admin.setEmail(adviserDTO.getEmail());
        if (adviserDTO.getImagePath() != null) admin.setImagePath(adviserDTO.getImagePath());
        if (adviserDTO.getDescription() != null) admin.setDescription(adviserDTO.getDescription());
    ...
    public List<AdviserDTO> getUsersByRole(String role) {
        // For student role, we need to handle null values as they're stored as null in the DB
